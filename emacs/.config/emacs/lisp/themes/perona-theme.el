...
(let ((base    "#261720")   ; darkest background
  ...
  (custom-theme-set-faces
   ...
   `(sailorfe-org-todo-wait ((t (:background ,kumashi :foreground ,light :weight bold))))
   ...
   ;; sections / headers
   `(magit-section-heading ((t (:foreground ,hollow :weight bold))))
   `(magit-section-heading-selection ((t (:background ,overlay :foreground ,hollow :weight bold))))
   `(magit-section-highlight ((t (:background ,surface))))

   ;; popup / transient interface
   `(transient-heading ((t (:foreground ,hollow :weight bold))))
   `(transient-key ((t (:foreground ,kumashi :weight bold))))
   `(transient-argument ((t (:foreground ,garden))))
   `(transient-value ((t (:foreground ,sangria))))
   `(transient-inactive-argument ((t (:foreground ,muted))))
   `(transient-inactive-value ((t (:foreground ,muted))))

   ;; branch / refs
   `(magit-branch-local ((t (:foreground ,garden :weight bold))))
   `(magit-branch-remote ((t (:foreground ,kumashi :weight bold))))
   `(magit-branch-current ((t (:foreground ,hollow :weight bold))))
   `(magit-branch-upstream ((t (:foreground ,sangria))))
   `(magit-head ((t (:foreground ,hollow :weight bold))))

   `(magit-tag ((t (:foreground ,zombie :weight bold))))
   ...
   `(magit-reflog-commit ((t (:foreground ,garden))))
   `(magit-reflog-other ((t (:foreground ,kumashi))))

   ;; commit messages
   `(magit-diff-file-heading ((t (:foreground ,hollow :weight bold))))
   `(magit-diff-file-heading-highlight ((t (:background ,surface :foreground ,hollow :weight bold))))
   `(magit-diff-file-heading-selection ((t (:background ,overlay :foreground ,light :weight bold))))
   `(magit-diff-hunk-heading ((t (:background ,surface :foreground ,kumashi))))
   `(magit-diff-hunk-heading-highlight ((t (:background ,overlay :foreground ,hollow))))
   ...
   `(magit-diff-added ((t (:foreground ,garden))))
   `(magit-diff-added-highlight ((t (:background ,garden :foreground ,base))))

   `(magit-diff-removed ((t (:foreground ,mihawk))))
   `(magit-diff-removed-highlight ((t (:background ,mihawk :foreground ,light))))

   `(magit-diff-added-highlight ((t (:background ,garden :foreground ,base))))
   `(magit-diff-removed-highlight ((t (:background ,mihawk :foreground ,light))))

   `(magit-diff-whitespace-warning ((t (:background ,sangria :foreground ,base))))

   ;; status buffer
   `(magit-diffstat-added ((t (:foreground ,garden))))
   `(magit-diffstat-removed ((t (:foreground ,mihawk))))
   `(magit-diffstat-neutral ((t (:foreground ,muted))))

   `(magit-status-heading ((t (:foreground ,hollow :weight bold))))
   `(magit-status-heading-key ((t (:foreground ,kumashi))))
   `(magit-status-untracked ((t (:foreground ,zombie))))
   `(magit-status-ignored ((t (:foreground ,muted))))
   `(magit-status-modified ((t (:foreground ,sangria))))
   `(magit-status-added ((t (:foreground ,garden))))
   `(magit-status-renamed ((t (:foreground ,kumashi))))
   `(magit-status-conflict ((t (:foreground ,mihawk :weight bold))))

   ;; process / errors
   `(magit-process-ok ((t (:foreground ,garden :weight bold))))
   `(magit-process-ng ((t (:foreground ,mihawk :weight bold))))
   ...
   `(magit-blame-name ((t (:foreground ,hollow))))
