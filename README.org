...
the main marks of this little unix environment are *text-first* and *keyboard-driven*, stubborn *manual configuration*, and *XDG compliance*. it also prioritizes portability,  prose, and for alliteration, python.
...
these days i use [[https://gnu.org/software/emacs][gnu emacs]] for intensive work and hop into either current vim or, on my alpine laptop, [[https://vim-classic.org][vim classic]] for quick edits, but this repository includes my [[https://neovim.io][neovim]] setup for posterity.
